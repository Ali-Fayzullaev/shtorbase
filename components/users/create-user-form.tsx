...
export function CreateUserForm() {
  ...
  return (
    <div className="glass-card rounded-xl p-5">
      <h2 className="text-[15px] font-semibold text-slate-800 dark:text-zinc-200 mb-4">Создать пользователя</h2>

      <form action={formAction} className="space-y-3">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            <label className="block text-[11px] font-medium text-slate-400 dark:text-zinc-500 mb-1 uppercase tracking-wider">ФИО</label>
            <input
              name="full_name"
              required
          ...
          <div>
            <label className="block text-[11px] font-medium text-slate-400 dark:text-zinc-500 mb-1 uppercase tracking-wider">Email</label>
            <input
              name="email"
              type="email"
              required
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            <label className="block text-[11px] font-medium text-slate-400 dark:text-zinc-500 mb-1 uppercase tracking-wider">Пароль</label>
            <div className="relative">
              <input
                ...
                className="w-full rounded-lg border border-slate-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 px-3 py-2 pr-9 text-[13px] text-slate-700 dark:text-zinc-300 placeholder:text-slate-400 dark:placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-300 transition-all"
              />
              <button
                type="button"
          ...
          <div>
            <label className="block text-[11px] font-medium text-slate-400 dark:text-zinc-500 mb-1 uppercase tracking-wider">Роль</label>
            <select
              name="role"
