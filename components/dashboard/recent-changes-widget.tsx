...
export function RecentChangesWidget({ logs }: RecentChangesWidgetProps) {
  return (
    <div className="rounded-2xl glass-card overflow-hidden !p-0">
      <div className="flex items-center gap-2 px-5 py-3.5 border-b border-white/30 dark:border-white/[0.05] bg-indigo-50/30 dark:bg-indigo-950/10">
      ...
      <div className="divide-y divide-zinc-50">
        {logs.length === 0 ? (
          ...
          logs.map((log) => (
            <div key={log.id} className="px-5 py-2.5 hover:bg-white/30 dark:hover:bg-white/[0.04] transition-colors">
