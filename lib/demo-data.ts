...
export const demoAuditLogs: AuditLog[] = [
  {
    ...
    user: { id: 'u2', full_name: 'Алия Кенесова', role: 'manager', is_active: true, created_at: '', updated_at: '' },
  ...
  },
  {
    ...
    user: { id: 'u3', full_name: 'Бахыт Муратов', role: 'manager', is_active: true, created_at: '', updated_at: '' },
