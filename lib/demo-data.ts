...
export const demoAuditLogs: AuditLog[] = [
  {
    ...
    user: { id: 'u2', full_name: 'Алия Кенесова', phone: null, role: 'manager', is_active: true, telegram_chat_id: null, created_at: '', updated_at: '' },
  ...
  },
  {
    ...
    user: { id: 'u3', full_name: 'Бахыт Муратов', phone: null, role: 'manager', is_active: true, telegram_chat_id: null, created_at: '', updated_at: '' },
